createCertificateForOrg2() {
  ...
  fabric-ca-client enroll -u https://admin:adminpw@localhost:8054 --caname ca.bank2.barclays.com --tls.certfiles ${PWD}/fabric-ca/bank2/tls-cert.pem
  ...
  fabric-ca-client enroll -u https://bank2admin:bank2adminpw@localhost:8054 --caname ca.bank2.barclays.com -M ${PWD}/../crypto-config/peerOrganizations/bank2.barclays.com/users/Admin@bank2.barclays.com/msp --tls.certfiles ${PWD}/fabric-ca/bank2/tls-cert.pem
