...
export PEER0_ORG2_CA=${PWD}/../vm2/crypto-config/peerOrganizations/financer1.hitachi.com/peers/peer0.financer1.hitachi.com/tls/ca.crt
export PEER0_ORG3_CA=${PWD}/../vm3/crypto-config/peerOrganizations/supplier1.hitachi.com/peers/peer0.supplier1.hitachi.com/tls/ca.crt
...
approveForMyOrg1() {
    ...
    peer lifecycle chaincode approveformyorg -o localhost:7050 \
        --ordererTLSHostnameOverride orderer.hitachi.com --tls \
...
commitChaincodeDefination() {
    setGlobalsForPeer0Org1
    peer lifecycle chaincode commit -o localhost:7050 --ordererTLSHostnameOverride orderer.hitachi.com \
