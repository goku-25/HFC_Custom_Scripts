createCretificateForOrderer() {
  ...
  fabric-ca-client enroll -u https://orderer:ordererpw@localhost:9054 --caname ca-orderer -M ${PWD}/../crypto-config/ordererOrganizations/barclays.com/orderers/orderer.barclays.com/msp --csr.hosts orderer.barclays.com --csr.hosts localhost --tls.certfiles ${PWD}/fabric-ca/ordererOrg/tls-cert.pem
  ...
  fabric-ca-client enroll -u https://orderer:ordererpw@localhost:9054 --caname ca-orderer -M ${PWD}/../crypto-config/ordererOrganizations/barclays.com/orderers/orderer.barclays.com/tls --enrollment.profile tls --csr.hosts orderer.barclays.com --csr.hosts localhost --tls.certfiles ${PWD}/fabric-ca/ordererOrg/tls-cert.pem
  ...
  fabric-ca-client enroll -u https://orderer2:ordererpw@localhost:9054 --caname ca-orderer -M ${PWD}/../crypto-config/ordererOrganizations/barclays.com/orderers/orderer2.barclays.com/msp --csr.hosts orderer2.barclays.com --csr.hosts localhost --tls.certfiles ${PWD}/fabric-ca/ordererOrg/tls-cert.pem
  ...
  fabric-ca-client enroll -u https://orderer2:ordererpw@localhost:9054 --caname ca-orderer -M ${PWD}/../crypto-config/ordererOrganizations/barclays.com/orderers/orderer2.barclays.com/tls --enrollment.profile tls --csr.hosts orderer2.barclays.com --csr.hosts localhost --tls.certfiles ${PWD}/fabric-ca/ordererOrg/tls-cert.pem
  ...
  fabric-ca-client enroll -u https://orderer3:ordererpw@localhost:9054 --caname ca-orderer -M ${PWD}/../crypto-config/ordererOrganizations/barclays.com/orderers/orderer3.barclays.com/msp --csr.hosts orderer3.barclays.com --csr.hosts localhost --tls.certfiles ${PWD}/fabric-ca/ordererOrg/tls-cert.pem
  ...
  fabric-ca-client enroll -u https://orderer3:ordererpw@localhost:9054 --caname ca-orderer -M ${PWD}/../crypto-config/ordererOrganizations/barclays.com/orderers/orderer3.barclays.com/tls --enrollment.profile tls --csr.hosts orderer3.barclays.com --csr.hosts localhost --tls.certfiles ${PWD}/fabric-ca/ordererOrg/tls-cert.pem
  ...
  fabric-ca-client enroll -u https://ordererAdmin:ordererAdminpw@localhost:9054 --caname ca-orderer -M ${PWD}/../crypto-config/ordererOrganizations/barclays.com/users/Admin@barclays.com/msp --tls.certfiles ${PWD}/fabric-ca/ordererOrg/tls-cert.pem
