createcertificatesForOrg1() {
  ...
  # mkdir -p ../crypto-config/peerOrganizations/bank1.barclays.com/peers/peer1.bank1.barclays.com

  # echo
  # echo "## Generate the peer1 msp"
  # echo
  # fabric-ca-client enroll -u https://peer1:peer1pw@localhost:7054 --caname ca.bank1.barclays.com -M ${PWD}/../crypto-config/peerOrganizations/bank1.barclays.com/peers/peer1.bank1.barclays.com/msp --csr.hosts peer1.bank1.barclays.com --tls.certfiles ${PWD}/fabric-ca/bank1/tls-cert.pem

  # cp ${PWD}/../crypto-config/peerOrganizations/bank1.barclays.com/msp/config.yaml ${PWD}/../crypto-config/peerOrganizations/bank1.barclays.com/peers/peer1.bank1.barclays.com/msp/config.yaml

  # echo
  # echo "## Generate the peer1-tls certificates"
  # echo
  # fabric-ca-client enroll -u https://peer1:peer1pw@localhost:7054 --caname ca.bank1.barclays.com -M ${PWD}/../crypto-config/peerOrganizations/bank1.barclays.com/peers/peer1.bank1.barclays.com/tls --enrollment.profile tls --csr.hosts peer1.bank1.barclays.com --csr.hosts localhost --tls.certfiles ${PWD}/fabric-ca/bank1/tls-cert.pem

  # cp ${PWD}/../crypto-config/peerOrganizations/bank1.barclays.com/peers/peer1.bank1.barclays.com/tls/tlscacerts/* ${PWD}/../crypto-config/peerOrganizations/bank1.barclays.com/peers/peer1.bank1.barclays.com/tls/ca.crt
  # cp ${PWD}/../crypto-config/peerOrganizations/bank1.barclays.com/peers/peer1.bank1.barclays.com/tls/signcerts/* ${PWD}/../crypto-config/peerOrganizations/bank1.barclays.com/peers/peer1.bank1.barclays.com/tls/server.crt
  # cp ${PWD}/../crypto-config/peerOrganizations/bank1.barclays.com/peers/peer1.bank1.barclays.com/tls/keystore/* ${PWD}/../crypto-config/peerOrganizations/bank1.barclays.com/peers/peer1.bank1.barclays.com/tls/server.key
