createcertificatesForOrg1() {
  ...
  fabric-ca-client enroll -u https://admin:adminpw@localhost:7054 --caname ca.bank2.barclays.com --tls.certfiles ${PWD}/fabric-ca/bank2/tls-cert.pem

  echo 'NodeOUs:
  Enable: true
  ClientOUIdentifier:
    Certificate: cacerts/localhost-7054-ca-bank2-barclays-com.pem
  ...
  echo
  fabric-ca-client register --caname ca.bank2.barclays.com --id.name bank2admin --id.secret bank2adminpw --id.type admin --tls.certfiles ${PWD}/fabric-ca/bank2/tls-cert.pem
  ...
  echo
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:7054 --caname ca.bank2.barclays.com -M ${PWD}/../crypto-config/peerOrganizations/bank2.barclays.com/peers/peer0.bank2.barclays.com/msp --csr.hosts peer0.bank2.barclays.com --tls.certfiles ${PWD}/fabric-ca/bank2/tls-cert.pem
  ...
  echo
  fabric-ca-client enroll -u https://user1:user1pw@localhost:7054 --caname ca.bank2.barclays.com -M ${PWD}/../crypto-config/peerOrganizations/bank2.barclays.com/users/User1@bank2.barclays.com/msp --tls.certfiles ${PWD}/fabric-ca/bank2/tls-cert.pem
  ...
  echo
  fabric-ca-client enroll -u https://bank2admin:bank2adminpw@localhost:7054 --caname ca.bank2.barclays.com -M ${PWD}/../crypto-config/peerOrganizations/bank2.barclays.com/users/Admin@bank2.barclays.com/msp --tls.certfiles ${PWD}/fabric-ca/bank2/tls-cert.pem
