createCertificateForOrg2() {
  ...
  echo
  mkdir -p ../crypto-config/peerOrganizations/bank2.barclays.com/

  export FABRIC_CA_CLIENT_HOME=${PWD}/../crypto-config/peerOrganizations/bank2.barclays.com/
  ...
  Enable: true
  ClientOUIdentifier:
    Certificate: cacerts/localhost-8054-ca-bank2-barclays-com.pem
  ...
  OrdererOUIdentifier:
    Certificate: cacerts/localhost-8054-ca-bank2-barclays-com.pem
    OrganizationalUnitIdentifier: orderer' >${PWD}/../crypto-config/peerOrganizations/bank2.barclays.com/msp/config.yaml

  echo
  echo "Register peer0"
  echo

  fabric-ca-client register --caname ca.bank1.barclays.com --id.name peer0 --id.secret peer0pw --id.type peer --tls.certfiles ${PWD}/fabric-ca/bank2/tls-cert.pem

#   echo
#   echo "Register peer1"
#   echo

#   fabric-ca-client register --caname ca.bank1.barclays.com --id.name peer1 --id.secret peer1pw --id.type peer --tls.certfiles ${PWD}/fabric-ca/bank2/tls-cert.pem

  echo
  echo "Register user"
  echo

  fabric-ca-client register --caname ca.bank1.barclays.com --id.name user1 --id.secret user1pw --id.type client --tls.certfiles ${PWD}/fabric-ca/bank2/tls-cert.pem

  echo
  echo "Register the org admin"
  echo

  fabric-ca-client register --caname ca.bank1.barclays.com --id.name bank2admin --id.secret bank2adminpw --id.type admin --tls.certfiles ${PWD}/fabric-ca/bank2/tls-cert.pem

  mkdir -p ../crypto-config/peerOrganizations/bank2.barclays.com/peers
  ...
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:8054 --caname ca.bank1.barclays.com -M ${PWD}/../crypto-config/peerOrganizations/bank2.barclays.com/peers/peer0.bank2.barclays.com/msp --csr.hosts peer0.bank2.barclays.com --tls.certfiles ${PWD}/fabric-ca/bank2/tls-cert.pem
  ...
  cp ${PWD}/../crypto-config/peerOrganizations/bank2.barclays.com/peers/peer0.bank2.barclays.com/msp/cacerts/* ${PWD}/../crypto-config/peerOrganizations/bank2.barclays.com/ca/ca.bank1.barclays.com-cert.pem
...
#   fabric-ca-client enroll -u https://peer1:peer1pw@localhost:8054 --caname ca.bank1.barclays.com -M ${PWD}/../crypto-config/peerOrganizations/bank2.barclays.com/peers/peer1.bank2.barclays.com/msp --csr.hosts peer1.bank2.barclays.com --tls.certfiles ${PWD}/fabric-ca/bank2/tls-cert.pem
...
#   fabric-ca-client enroll -u https://peer1:peer1pw@localhost:8054 --caname ca.bank1.barclays.com -M ${PWD}/../crypto-config/peerOrganizations/bank2.barclays.com/peers/peer1.bank2.barclays.com/tls --enrollment.profile tls --csr.hosts peer1.bank2.barclays.com --csr.hosts localhost --tls.certfiles ${PWD}/fabric-ca/bank2/tls-cert.pem
...
#   cp ${PWD}/../crypto-config/peerOrganizations/bank2.barclays.com/peers/peer1.bank2.barclays.com/tls/keystore/* ${PWD}/../crypto-config/peerOrganizations/bank2.barclays.com/peers/peer1.bank2.barclays.com/tls/server.key
  ...
  mkdir -p ../crypto-config/peerOrganizations/bank2.barclays.com/users/User1@bank2.barclays.com

  echo
  echo "## Generate the user msp"
  echo

  fabric-ca-client enroll -u https://user1:user1pw@localhost:8054 --caname ca.bank1.barclays.com -M ${PWD}/../crypto-config/peerOrganizations/bank2.barclays.com/users/User1@bank2.barclays.com/msp --tls.certfiles ${PWD}/fabric-ca/bank2/tls-cert.pem
  ...
  fabric-ca-client enroll -u https://bank2admin:bank2adminpw@localhost:8054 --caname ca.bank1.barclays.com -M ${PWD}/../crypto-config/peerOrganizations/bank2.barclays.com/users/Admin@bank2.barclays.com/msp --tls.certfiles ${PWD}/fabric-ca/bank2/tls-cert.pem

  cp ${PWD}/../crypto-config/peerOrganizations/bank2.barclays.com/msp/config.yaml ${PWD}/../crypto-config/peerOrganizations/bank2.barclays.com/users/Admin@bank2.barclays.com/msp/config.yaml
