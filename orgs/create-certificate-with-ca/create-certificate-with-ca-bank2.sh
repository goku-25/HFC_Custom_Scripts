...
#   fabric-ca-client register --caname ca.bank1.barclays.com --id.name peer1 --id.secret peer1pw --id.type peer --tls.certfiles ${PWD}/fabric-ca/bank1/tls-cert.pem
  ...
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:8054 --caname ca.bank1.barclays.com -M ${PWD}/../crypto-config/peerOrganizations/bank2.barclays.com/peers/peer0.bank2.barclays.com/msp --csr.hosts peer0.bank2.barclays.com --tls.certfiles ${PWD}/fabric-ca/bank1/tls-cert.pem
