createcertificatesForOrg1() {
  ...
  fabric-ca-client enroll -u https://admin:adminpw@localhost:7054 --caname ca.nonbank.barclays.com --tls.certfiles ${PWD}/fabric-ca/nonbank/tls-cert.pem

  echo 'NodeOUs:
  Enable: true
  ClientOUIdentifier:
    Certificate: cacerts/localhost-7054-ca-nonbank-barclays-com.pem
  ...
  echo
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:7054 --caname ca.nonbank.barclays.com -M ${PWD}/../crypto-config/peerOrganizations/nonbank.barclays.com/peers/peer0.nonbank.barclays.com/msp --csr.hosts peer0.nonbank.barclays.com --tls.certfiles ${PWD}/fabric-ca/nonbank/tls-cert.pem
  ...
  echo
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:7054 --caname ca.nonbank.barclays.com -M ${PWD}/../crypto-config/peerOrganizations/nonbank.barclays.com/peers/peer0.nonbank.barclays.com/tls --enrollment.profile tls --csr.hosts peer0.nonbank.barclays.com --csr.hosts localhost --tls.certfiles ${PWD}/fabric-ca/nonbank/tls-cert.pem
  ...
  echo
  fabric-ca-client enroll -u https://user1:user1pw@localhost:7054 --caname ca.nonbank.barclays.com -M ${PWD}/../crypto-config/peerOrganizations/nonbank.barclays.com/users/User1@nonbank.barclays.com/msp --tls.certfiles ${PWD}/fabric-ca/nonbank/tls-cert.pem
  ...
  echo
  fabric-ca-client enroll -u https://nonbankadmin:nonbankadminpw@localhost:7054 --caname ca.nonbank.barclays.com -M ${PWD}/../crypto-config/peerOrganizations/nonbank.barclays.com/users/Admin@nonbank.barclays.com/msp --tls.certfiles ${PWD}/fabric-ca/nonbank/tls-cert.pem
