createcertificatesForOrg3() {
  ...
  echo
  fabric-ca-client enroll -u https://peer2:peer2pw@localhost:10054 --caname ca.bank1.barclays.com -M ${PWD}/../crypto-config/peerOrganizations/nonbank.barclays.com/peers/peer2.nonbank.barclays.com/msp --csr.hosts peer2.nonbank.barclays.com --tls.certfiles ${PWD}/fabric-ca/bank1/tls-cert.pem
  ...
  echo
  fabric-ca-client enroll -u https://peer2:peer2pw@localhost:10054 --caname ca.bank1.barclays.com -M ${PWD}/../crypto-config/peerOrganizations/nonbank.barclays.com/peers/peer2.nonbank.barclays.com/tls --enrollment.profile tls --csr.hosts peer2.nonbank.barclays.com --csr.hosts localhost --tls.certfiles ${PWD}/fabric-ca/bank1/tls-cert.pem
